...
//     simple-icons@12.4.0 (brand hex #107C10) and inlined here.
...
//
// All marks render monochrome via `currentColor` to respect the restrained
// palette and BRAND.md's "no hardcoded hex in components" rule; a text label
// always sits alongside in the UI, so the icons are decorative there.
// ============================================================================
